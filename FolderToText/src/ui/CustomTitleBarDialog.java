...
import java.net.URL;
import javax.swing.ImageIcon; // JButton importu titleBar için kullanılıyordu, DialogTitleBar için gerekmeyebilir
...
public class CustomTitleBarDialog extends JPanel {
	...
	public CustomTitleBarDialog(JDialog parentDialog, String title) {
